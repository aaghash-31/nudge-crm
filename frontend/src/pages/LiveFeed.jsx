      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div ref={feedRef} className="overflow-y-auto" style={{ height: '480px' }}>
              {events.length === 0 ? (
                ...
                <div className="divide-y divide-gray-50">
                  {events.map(ev => (
                    <div key={ev.id} className="flex items-start gap-3 px-5 py-3 animate-fade-in">
            ...
            {complete && (
              <div className="bg-indigo-600 rounded-2xl p-5 text-white">
                ...
                <p className="text-indigo-200 text-sm mb-4">
                  All delivery callbacks received. Generate your AI post-mortem now.
                </p>
                <button
            ...
            {!complete && (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                <p className="text-sm text-gray-500 text-center">
                  Campaign running · post-mortem available when complete
                </p>
                <button
                  onClick={() => navigate(`/campaigns/${id}/postmortem`)}
